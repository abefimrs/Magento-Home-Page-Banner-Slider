...
class Cpcoder_Slider_Adminhtml_SliderController extends Mage_Adminhtml_Controller_Action
{
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != null) {
				try {	
					...
					$path = Mage::getBaseDir('media') . DS.'cpcoder/slider'.DS ;
		        ...
		        $basepath=Mage::getBaseUrl().'media/cpcoder/slider/';
